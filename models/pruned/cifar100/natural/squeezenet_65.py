...
class SqueezeNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.fire4_conv2 = nn.Conv2d(32, 79, kernel_size=(1, 1), stride=(1, 1))
        self.fire4_bn2 = nn.BatchNorm2d(79, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire4_conv3 = nn.Conv2d(32, 105, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire4_bn3 = nn.BatchNorm2d(105, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.maxpool2 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
        self.fire5_conv1 = nn.Conv2d(184, 31, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire5_conv3 = nn.Conv2d(31, 75, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire5_bn3 = nn.BatchNorm2d(75, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire6_conv1 = nn.Conv2d(202, 48, kernel_size=(1, 1), stride=(1, 1))
        self.fire6_bn1 = nn.BatchNorm2d(48, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire6_conv2 = nn.Conv2d(48, 110, kernel_size=(1, 1), stride=(1, 1))
        self.fire6_bn2 = nn.BatchNorm2d(110, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire6_conv3 = nn.Conv2d(48, 24, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire6_bn3 = nn.BatchNorm2d(24, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire7_conv1 = nn.Conv2d(134, 48, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire7_conv3 = nn.Conv2d(48, 100, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire7_bn3 = nn.BatchNorm2d(100, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire8_conv1 = nn.Conv2d(269, 64, kernel_size=(1, 1), stride=(1, 1))
        self.fire8_bn1 = nn.BatchNorm2d(64, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire8_conv2 = nn.Conv2d(64, 230, kernel_size=(1, 1), stride=(1, 1))
        self.fire8_bn2 = nn.BatchNorm2d(230, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire8_conv3 = nn.Conv2d(64, 69, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire8_bn3 = nn.BatchNorm2d(69, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.maxpool3 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
        self.fire9_conv1 = nn.Conv2d(299, 64, kernel_size=(1, 1), stride=(1, 1))
