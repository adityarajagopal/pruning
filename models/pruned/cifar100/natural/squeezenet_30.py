...
class SqueezeNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.conv1 = nn.Conv2d(3, 82, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.bn1 = nn.BatchNorm2d(82, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.maxpool1 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
        self.fire2_conv1 = nn.Conv2d(82, 15, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire2_conv3 = nn.Conv2d(15, 57, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire2_bn3 = nn.BatchNorm2d(57, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire3_conv1 = nn.Conv2d(121, 16, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire4_conv2 = nn.Conv2d(32, 116, kernel_size=(1, 1), stride=(1, 1))
        self.fire4_bn2 = nn.BatchNorm2d(116, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.fire5_conv1 = nn.Conv2d(244, 32, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire6_conv2 = nn.Conv2d(48, 173, kernel_size=(1, 1), stride=(1, 1))
        self.fire6_bn2 = nn.BatchNorm2d(173, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire6_conv3 = nn.Conv2d(48, 161, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire6_bn3 = nn.BatchNorm2d(161, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.fire8_conv1 = nn.Conv2d(381, 64, kernel_size=(1, 1), stride=(1, 1))
