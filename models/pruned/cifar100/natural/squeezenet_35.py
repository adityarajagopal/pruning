...
class SqueezeNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.fire4_conv2 = nn.Conv2d(32, 107, kernel_size=(1, 1), stride=(1, 1))
        self.fire4_bn2 = nn.BatchNorm2d(107, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.fire5_conv1 = nn.Conv2d(235, 32, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire5_conv3 = nn.Conv2d(32, 120, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire5_bn3 = nn.BatchNorm2d(120, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire6_conv1 = nn.Conv2d(247, 48, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire6_conv3 = nn.Conv2d(48, 107, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire6_bn3 = nn.BatchNorm2d(107, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire7_conv1 = nn.Conv2d(266, 48, kernel_size=(1, 1), stride=(1, 1))
        self.fire7_bn1 = nn.BatchNorm2d(48, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire7_conv2 = nn.Conv2d(48, 189, kernel_size=(1, 1), stride=(1, 1))
        self.fire7_bn2 = nn.BatchNorm2d(189, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire7_conv3 = nn.Conv2d(48, 185, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire7_bn3 = nn.BatchNorm2d(185, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire8_conv1 = nn.Conv2d(374, 64, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire8_conv3 = nn.Conv2d(64, 250, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire8_bn3 = nn.BatchNorm2d(250, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.maxpool3 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
        self.fire9_conv1 = nn.Conv2d(496, 64, kernel_size=(1, 1), stride=(1, 1))
