...
class ResNet20(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.layer2_0_downsample_0 = nn.Conv2d(7, 20, kernel_size=(1, 1), stride=(2, 2), bias=False)
        ...
        self.layer3_0_downsample_0 = nn.Conv2d(20, 26, kernel_size=(1, 1), stride=(2, 2), bias=False)
        ...
        self.layer3_2_conv1 = nn.Conv2d(26, 44, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
        self.layer3_2_bn1 = nn.BatchNorm2d(44, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layer3_2_conv2 = nn.Conv2d(44, 26, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
