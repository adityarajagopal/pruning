...
class SqueezeNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.conv1 = nn.Conv2d(3, 77, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.bn1 = nn.BatchNorm2d(77, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.maxpool1 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
        self.fire2_conv1 = nn.Conv2d(77, 15, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire2_conv3 = nn.Conv2d(15, 43, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire2_bn3 = nn.BatchNorm2d(43, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire3_conv1 = nn.Conv2d(107, 16, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire3_conv3 = nn.Conv2d(16, 63, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire3_bn3 = nn.BatchNorm2d(63, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire4_conv1 = nn.Conv2d(127, 32, kernel_size=(1, 1), stride=(1, 1))
        self.fire4_bn1 = nn.BatchNorm2d(32, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire4_conv2 = nn.Conv2d(32, 84, kernel_size=(1, 1), stride=(1, 1))
        self.fire4_bn2 = nn.BatchNorm2d(84, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire4_conv3 = nn.Conv2d(32, 121, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire4_bn3 = nn.BatchNorm2d(121, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.maxpool2 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
        self.fire5_conv1 = nn.Conv2d(205, 32, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire5_conv3 = nn.Conv2d(32, 96, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire5_bn3 = nn.BatchNorm2d(96, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire6_conv1 = nn.Conv2d(223, 48, kernel_size=(1, 1), stride=(1, 1))
        self.fire6_bn1 = nn.BatchNorm2d(48, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire6_conv2 = nn.Conv2d(48, 128, kernel_size=(1, 1), stride=(1, 1))
        self.fire6_bn2 = nn.BatchNorm2d(128, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire6_conv3 = nn.Conv2d(48, 38, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire6_bn3 = nn.BatchNorm2d(38, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire7_conv1 = nn.Conv2d(166, 48, kernel_size=(1, 1), stride=(1, 1))
        self.fire7_bn1 = nn.BatchNorm2d(48, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire7_conv2 = nn.Conv2d(48, 174, kernel_size=(1, 1), stride=(1, 1))
        self.fire7_bn2 = nn.BatchNorm2d(174, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire7_conv3 = nn.Conv2d(48, 133, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire7_bn3 = nn.BatchNorm2d(133, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire8_conv1 = nn.Conv2d(307, 64, kernel_size=(1, 1), stride=(1, 1))
        self.fire8_bn1 = nn.BatchNorm2d(64, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire8_conv2 = nn.Conv2d(64, 237, kernel_size=(1, 1), stride=(1, 1))
        self.fire8_bn2 = nn.BatchNorm2d(237, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire8_conv3 = nn.Conv2d(64, 128, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire8_bn3 = nn.BatchNorm2d(128, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.maxpool3 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
        self.fire9_conv1 = nn.Conv2d(365, 64, kernel_size=(1, 1), stride=(1, 1))
