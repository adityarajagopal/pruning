...
class SqueezeNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.fire4_conv2 = nn.Conv2d(32, 56, kernel_size=(1, 1), stride=(1, 1))
        self.fire4_bn2 = nn.BatchNorm2d(56, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.fire5_conv1 = nn.Conv2d(86, 31, kernel_size=(1, 1), stride=(1, 1))
        self.fire5_bn1 = nn.BatchNorm2d(31, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire5_conv2 = nn.Conv2d(31, 123, kernel_size=(1, 1), stride=(1, 1))
        self.fire5_bn2 = nn.BatchNorm2d(123, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire5_conv3 = nn.Conv2d(31, 16, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire5_bn3 = nn.BatchNorm2d(16, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire6_conv1 = nn.Conv2d(139, 48, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire8_conv2 = nn.Conv2d(64, 184, kernel_size=(1, 1), stride=(1, 1))
        self.fire8_bn2 = nn.BatchNorm2d(184, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.fire9_conv1 = nn.Conv2d(186, 64, kernel_size=(1, 1), stride=(1, 1))
