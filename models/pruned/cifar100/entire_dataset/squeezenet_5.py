...
class SqueezeNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.conv1 = nn.Conv2d(3, 87, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.bn1 = nn.BatchNorm2d(87, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.maxpool1 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
        self.fire2_conv1 = nn.Conv2d(87, 15, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire8_conv2 = nn.Conv2d(64, 249, kernel_size=(1, 1), stride=(1, 1))
        self.fire8_bn2 = nn.BatchNorm2d(249, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.fire9_conv1 = nn.Conv2d(505, 64, kernel_size=(1, 1), stride=(1, 1))
        self.fire9_bn1 = nn.BatchNorm2d(64, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire9_conv2 = nn.Conv2d(64, 31, kernel_size=(1, 1), stride=(1, 1))
        self.fire9_bn2 = nn.BatchNorm2d(31, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.conv2 = nn.Conv2d(287, 100, kernel_size=(1, 1), stride=(1, 1))
