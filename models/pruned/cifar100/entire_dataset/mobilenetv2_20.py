...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.layers_13_conv1 = nn.Conv2d(96, 443, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_13_bn1 = nn.BatchNorm2d(443, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_13_conv2 = nn.Conv2d(443, 443, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), groups=443, bias=False)
        self.layers_13_bn2 = nn.BatchNorm2d(443, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_13_conv3 = nn.Conv2d(443, 160, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_16_conv1 = nn.Conv2d(160, 646, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_16_bn1 = nn.BatchNorm2d(646, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_16_conv2 = nn.Conv2d(646, 646, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=646, bias=False)
        self.layers_16_bn2 = nn.BatchNorm2d(646, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_16_conv3 = nn.Conv2d(646, 320, kernel_size=(1, 1), stride=(1, 1), bias=False)
