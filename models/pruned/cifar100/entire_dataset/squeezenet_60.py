...
class SqueezeNet(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.fire4_conv3 = nn.Conv2d(32, 113, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire4_bn3 = nn.BatchNorm2d(113, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		...
		self.fire5_conv3 = nn.Conv2d(32, 83, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire5_bn3 = nn.BatchNorm2d(83, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire6_conv1 = nn.Conv2d(210, 48, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire8_conv1 = nn.Conv2d(278, 64, kernel_size=(1, 1), stride=(1, 1))
		self.fire8_bn1 = nn.BatchNorm2d(64, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire8_conv2 = nn.Conv2d(64, 236, kernel_size=(1, 1), stride=(1, 1))
		self.fire8_bn2 = nn.BatchNorm2d(236, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		...
		self.fire9_conv1 = nn.Conv2d(344, 64, kernel_size=(1, 1), stride=(1, 1))
