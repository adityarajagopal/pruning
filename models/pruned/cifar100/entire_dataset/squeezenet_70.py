...
class SqueezeNet(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.fire4_conv3 = nn.Conv2d(32, 91, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire4_bn3 = nn.BatchNorm2d(91, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.maxpool2 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
		self.fire5_conv1 = nn.Conv2d(162, 32, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire5_conv3 = nn.Conv2d(32, 63, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire5_bn3 = nn.BatchNorm2d(63, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire6_conv1 = nn.Conv2d(190, 48, kernel_size=(1, 1), stride=(1, 1))
		self.fire6_bn1 = nn.BatchNorm2d(48, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire6_conv2 = nn.Conv2d(48, 104, kernel_size=(1, 1), stride=(1, 1))
		self.fire6_bn2 = nn.BatchNorm2d(104, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		...
		self.fire7_conv1 = nn.Conv2d(121, 48, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire8_conv2 = nn.Conv2d(64, 223, kernel_size=(1, 1), stride=(1, 1))
		self.fire8_bn2 = nn.BatchNorm2d(223, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		...
		self.fire9_conv1 = nn.Conv2d(269, 64, kernel_size=(1, 1), stride=(1, 1))
