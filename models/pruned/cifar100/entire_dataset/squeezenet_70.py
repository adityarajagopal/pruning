...
class SqueezeNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.fire6_conv3 = nn.Conv2d(48, 18, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire6_bn3 = nn.BatchNorm2d(18, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
