...
class SqueezeNet(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.fire8_conv2 = nn.Conv2d(64, 231, kernel_size=(1, 1), stride=(1, 1))
		self.fire8_bn2 = nn.BatchNorm2d(231, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		...
		self.fire9_conv1 = nn.Conv2d(304, 64, kernel_size=(1, 1), stride=(1, 1))
