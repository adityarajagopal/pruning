...
class SqueezeNet(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.fire4_conv2 = nn.Conv2d(32, 77, kernel_size=(1, 1), stride=(1, 1))
		self.fire4_bn2 = nn.BatchNorm2d(77, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire4_conv3 = nn.Conv2d(32, 111, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire4_bn3 = nn.BatchNorm2d(111, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.maxpool2 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
		self.fire5_conv1 = nn.Conv2d(188, 32, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire5_conv3 = nn.Conv2d(32, 82, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire5_bn3 = nn.BatchNorm2d(82, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire6_conv1 = nn.Conv2d(209, 48, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire6_conv3 = nn.Conv2d(48, 26, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire6_bn3 = nn.BatchNorm2d(26, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire7_conv1 = nn.Conv2d(141, 48, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire7_conv3 = nn.Conv2d(48, 107, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire7_bn3 = nn.BatchNorm2d(107, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire8_conv1 = nn.Conv2d(274, 64, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire9_conv1 = nn.Conv2d(335, 64, kernel_size=(1, 1), stride=(1, 1))
