...
class SqueezeNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.conv1 = nn.Conv2d(3, 96, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        ...
        self.fire2_conv1 = nn.Conv2d(96, 16, kernel_size=(1, 1), stride=(1, 1))
        self.fire2_bn1 = nn.BatchNorm2d(16, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire2_conv2 = nn.Conv2d(16, 64, kernel_size=(1, 1), stride=(1, 1))
        self.fire2_bn2 = nn.BatchNorm2d(64, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire2_conv3 = nn.Conv2d(16, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        ...
        self.fire4_conv2 = nn.Conv2d(32, 128, kernel_size=(1, 1), stride=(1, 1))
        self.fire4_bn2 = nn.BatchNorm2d(128, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.fire5_conv1 = nn.Conv2d(256, 32, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire6_conv3 = nn.Conv2d(48, 185, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire6_bn3 = nn.BatchNorm2d(185, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire7_conv1 = nn.Conv2d(377, 47, kernel_size=(1, 1), stride=(1, 1))
        self.fire7_bn1 = nn.BatchNorm2d(47, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire7_conv2 = nn.Conv2d(47, 192, kernel_size=(1, 1), stride=(1, 1))
        self.fire7_bn2 = nn.BatchNorm2d(192, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire7_conv3 = nn.Conv2d(47, 183, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire7_bn3 = nn.BatchNorm2d(183, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire8_conv1 = nn.Conv2d(375, 64, kernel_size=(1, 1), stride=(1, 1))
        self.fire8_bn1 = nn.BatchNorm2d(64, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire8_conv2 = nn.Conv2d(64, 256, kernel_size=(1, 1), stride=(1, 1))
        self.fire8_bn2 = nn.BatchNorm2d(256, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.fire9_conv1 = nn.Conv2d(258, 8, kernel_size=(1, 1), stride=(1, 1))
        self.fire9_bn1 = nn.BatchNorm2d(8, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire9_conv2 = nn.Conv2d(8, 256, kernel_size=(1, 1), stride=(1, 1))
        self.fire9_bn2 = nn.BatchNorm2d(256, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire9_conv3 = nn.Conv2d(8, 2, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire9_bn3 = nn.BatchNorm2d(2, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.conv2 = nn.Conv2d(258, 100, kernel_size=(1, 1), stride=(1, 1))
