...
class SqueezeNet(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.fire7_conv3 = nn.Conv2d(48, 108, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire7_bn3 = nn.BatchNorm2d(108, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire8_conv1 = nn.Conv2d(275, 64, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire8_conv3 = nn.Conv2d(64, 100, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire8_bn3 = nn.BatchNorm2d(100, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.maxpool3 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
		self.fire9_conv1 = nn.Conv2d(334, 64, kernel_size=(1, 1), stride=(1, 1))
