...
class MobileNetV2(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.layers_16_conv3 = nn.Conv2d(287, 154, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_bn3 = nn.BatchNorm2d(154, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_16_shortcut_0 = nn.Conv2d(87, 154, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_shortcut_1 = nn.BatchNorm2d(154, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.conv2 = nn.Conv2d(154, 1056, kernel_size=(1, 1), stride=(1, 1), bias=False)
