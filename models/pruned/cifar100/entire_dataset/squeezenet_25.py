...
class SqueezeNet(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.fire4_conv2 = nn.Conv2d(32, 123, kernel_size=(1, 1), stride=(1, 1))
		self.fire4_bn2 = nn.BatchNorm2d(123, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		...
		self.fire5_conv1 = nn.Conv2d(251, 32, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire6_conv2 = nn.Conv2d(48, 184, kernel_size=(1, 1), stride=(1, 1))
		self.fire6_bn2 = nn.BatchNorm2d(184, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire6_conv3 = nn.Conv2d(48, 189, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire6_bn3 = nn.BatchNorm2d(189, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire7_conv1 = nn.Conv2d(373, 48, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire9_conv3 = nn.Conv2d(64, 36, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire9_bn3 = nn.BatchNorm2d(36, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.conv2 = nn.Conv2d(38, 100, kernel_size=(1, 1), stride=(1, 1))
