...
class AlexNet(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.conv3 = nn.Conv2d(192, 364, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.conv4 = nn.Conv2d(364, 248, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.conv5 = nn.Conv2d(248, 256, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
