...
class ResNet20(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.layer1_0_conv1 = nn.Conv2d(4, 13, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
		self.layer1_0_bn1 = nn.BatchNorm2d(13, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layer1_0_conv2 = nn.Conv2d(13, 4, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
		...
		self.layer2_1_conv1 = nn.Conv2d(12, 23, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
		self.layer2_1_bn1 = nn.BatchNorm2d(23, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layer2_1_conv2 = nn.Conv2d(23, 12, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
		...
		self.layer3_0_conv1 = nn.Conv2d(12, 50, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), bias=False)
		self.layer3_0_bn1 = nn.BatchNorm2d(50, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layer3_0_conv2 = nn.Conv2d(50, 13, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
		...
		self.layer3_1_conv1 = nn.Conv2d(13, 45, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
		self.layer3_1_bn1 = nn.BatchNorm2d(45, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layer3_1_conv2 = nn.Conv2d(45, 13, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
