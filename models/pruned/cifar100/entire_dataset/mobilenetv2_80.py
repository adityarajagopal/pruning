...
class MobileNetV2(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.layers_0_conv1 = nn.Conv2d(15, 2, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_0_conv3 = nn.Conv2d(2, 10, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_0_bn3 = nn.BatchNorm2d(10, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_0_shortcut_0 = nn.Conv2d(15, 10, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_0_shortcut_1 = nn.BatchNorm2d(10, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_1_conv1 = nn.Conv2d(10, 2, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_1_shortcut_0 = nn.Conv2d(10, 7, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_3_conv1 = nn.Conv2d(7, 2, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_3_bn1 = nn.BatchNorm2d(2, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_3_conv2 = nn.Conv2d(2, 2, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), groups=2, bias=False)
		self.layers_3_bn2 = nn.BatchNorm2d(2, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_3_conv3 = nn.Conv2d(2, 7, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_16_conv3 = nn.Conv2d(2, 118, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_bn3 = nn.BatchNorm2d(118, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_16_shortcut_0 = nn.Conv2d(32, 118, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_shortcut_1 = nn.BatchNorm2d(118, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.conv2 = nn.Conv2d(118, 618, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.bn2 = nn.BatchNorm2d(618, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.linear = nn.Linear(in_features=618, out_features=100, bias=True)
