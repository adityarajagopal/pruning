...
class SqueezeNet(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.fire9_conv3 = nn.Conv2d(64, 150, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire9_bn3 = nn.BatchNorm2d(150, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.conv2 = nn.Conv2d(152, 100, kernel_size=(1, 1), stride=(1, 1))
