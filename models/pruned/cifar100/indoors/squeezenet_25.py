...
class SqueezeNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.fire4_conv2 = nn.Conv2d(32, 122, kernel_size=(1, 1), stride=(1, 1))
        self.fire4_bn2 = nn.BatchNorm2d(122, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.fire5_conv1 = nn.Conv2d(250, 32, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire6_conv2 = nn.Conv2d(48, 185, kernel_size=(1, 1), stride=(1, 1))
        self.fire6_bn2 = nn.BatchNorm2d(185, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire6_conv3 = nn.Conv2d(48, 191, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire6_bn3 = nn.BatchNorm2d(191, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire7_conv1 = nn.Conv2d(376, 48, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire9_conv3 = nn.Conv2d(64, 34, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire9_bn3 = nn.BatchNorm2d(34, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.conv2 = nn.Conv2d(36, 100, kernel_size=(1, 1), stride=(1, 1))
