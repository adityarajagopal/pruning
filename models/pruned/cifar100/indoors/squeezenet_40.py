...
class SqueezeNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.fire6_conv2 = nn.Conv2d(48, 146, kernel_size=(1, 1), stride=(1, 1))
        self.fire6_bn2 = nn.BatchNorm2d(146, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire6_conv3 = nn.Conv2d(48, 68, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire6_bn3 = nn.BatchNorm2d(68, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire7_conv1 = nn.Conv2d(214, 48, kernel_size=(1, 1), stride=(1, 1))
