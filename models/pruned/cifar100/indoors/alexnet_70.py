...
class AlexNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.conv3 = nn.Conv2d(182, 142, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.conv4 = nn.Conv2d(142, 51, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.conv5 = nn.Conv2d(51, 239, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
