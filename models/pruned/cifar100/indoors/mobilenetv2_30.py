...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.layers_11_conv1 = nn.Conv2d(96, 356, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_11_bn1 = nn.BatchNorm2d(356, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_11_conv2 = nn.Conv2d(356, 356, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=356, bias=False)
        self.layers_11_bn2 = nn.BatchNorm2d(356, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_11_conv3 = nn.Conv2d(356, 96, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_11_bn3 = nn.BatchNorm2d(96, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_12_conv1 = nn.Conv2d(96, 375, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_12_bn1 = nn.BatchNorm2d(375, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_12_conv2 = nn.Conv2d(375, 375, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=375, bias=False)
        self.layers_12_bn2 = nn.BatchNorm2d(375, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_12_conv3 = nn.Conv2d(375, 96, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_15_conv1 = nn.Conv2d(160, 574, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_15_bn1 = nn.BatchNorm2d(574, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_15_conv2 = nn.Conv2d(574, 574, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=574, bias=False)
        self.layers_15_bn2 = nn.BatchNorm2d(574, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_15_conv3 = nn.Conv2d(574, 160, kernel_size=(1, 1), stride=(1, 1), bias=False)
