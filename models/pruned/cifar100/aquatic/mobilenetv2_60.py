...
class MobileNetV2(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.layers_6_conv3 = nn.Conv2d(138, 46, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_6_bn3 = nn.BatchNorm2d(46, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_7_conv1 = nn.Conv2d(46, 217, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_7_conv3 = nn.Conv2d(217, 46, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_8_conv1 = nn.Conv2d(46, 196, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_8_conv3 = nn.Conv2d(196, 46, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_9_conv1 = nn.Conv2d(46, 157, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_9_bn1 = nn.BatchNorm2d(157, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_9_conv2 = nn.Conv2d(157, 157, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=157, bias=False)
		self.layers_9_bn2 = nn.BatchNorm2d(157, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_9_conv3 = nn.Conv2d(157, 46, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_10_conv1 = nn.Conv2d(46, 213, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_10_conv3 = nn.Conv2d(213, 61, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_11_conv1 = nn.Conv2d(61, 230, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_11_conv3 = nn.Conv2d(230, 61, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_12_conv1 = nn.Conv2d(61, 241, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_12_bn1 = nn.BatchNorm2d(241, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_12_conv2 = nn.Conv2d(241, 241, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=241, bias=False)
		self.layers_12_bn2 = nn.BatchNorm2d(241, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_12_conv3 = nn.Conv2d(241, 61, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_13_conv1 = nn.Conv2d(61, 260, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_13_conv3 = nn.Conv2d(260, 119, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_13_bn3 = nn.BatchNorm2d(119, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_14_conv1 = nn.Conv2d(119, 477, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_14_conv3 = nn.Conv2d(477, 119, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_14_bn3 = nn.BatchNorm2d(119, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_14_shortcut = nn.Sequential()
		self.layers_15_conv1 = nn.Conv2d(119, 364, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_15_conv3 = nn.Conv2d(364, 119, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_15_bn3 = nn.BatchNorm2d(119, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_15_shortcut = nn.Sequential()
		self.layers_16_conv1 = nn.Conv2d(119, 299, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_16_conv3 = nn.Conv2d(299, 213, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_bn3 = nn.BatchNorm2d(213, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_16_shortcut_0 = nn.Conv2d(119, 213, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_shortcut_1 = nn.BatchNorm2d(213, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.conv2 = nn.Conv2d(213, 1146, kernel_size=(1, 1), stride=(1, 1), bias=False)
