...
class MobileNetV2(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.layers_7_conv1 = nn.Conv2d(47, 215, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_7_conv3 = nn.Conv2d(215, 47, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_8_conv1 = nn.Conv2d(47, 199, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_8_conv3 = nn.Conv2d(199, 47, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_9_conv1 = nn.Conv2d(47, 150, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_9_conv3 = nn.Conv2d(150, 47, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_10_conv1 = nn.Conv2d(47, 212, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_10_conv3 = nn.Conv2d(212, 60, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_10_bn3 = nn.BatchNorm2d(60, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_10_shortcut_0 = nn.Conv2d(47, 60, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_10_shortcut_1 = nn.BatchNorm2d(60, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_11_conv1 = nn.Conv2d(60, 234, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_11_bn1 = nn.BatchNorm2d(234, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_11_conv2 = nn.Conv2d(234, 234, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=234, bias=False)
		self.layers_11_bn2 = nn.BatchNorm2d(234, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_11_conv3 = nn.Conv2d(234, 60, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_12_conv1 = nn.Conv2d(60, 239, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_12_conv3 = nn.Conv2d(239, 60, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_13_conv1 = nn.Conv2d(60, 260, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_13_conv3 = nn.Conv2d(260, 121, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_13_bn3 = nn.BatchNorm2d(121, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_14_conv1 = nn.Conv2d(121, 478, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_14_conv3 = nn.Conv2d(478, 121, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_15_conv1 = nn.Conv2d(121, 368, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_15_bn1 = nn.BatchNorm2d(368, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_15_conv2 = nn.Conv2d(368, 368, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=368, bias=False)
		self.layers_15_bn2 = nn.BatchNorm2d(368, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_15_conv3 = nn.Conv2d(368, 121, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_16_conv3 = nn.Conv2d(297, 211, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_bn3 = nn.BatchNorm2d(211, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_16_shortcut_0 = nn.Conv2d(121, 211, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_shortcut_1 = nn.BatchNorm2d(211, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.conv2 = nn.Conv2d(211, 1144, kernel_size=(1, 1), stride=(1, 1), bias=False)
