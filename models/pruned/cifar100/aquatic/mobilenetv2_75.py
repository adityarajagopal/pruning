...
class MobileNetV2(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.layers_3_conv1 = nn.Conv2d(16, 118, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_4_conv1 = nn.Conv2d(30, 103, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_4_conv3 = nn.Conv2d(103, 30, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_8_conv1 = nn.Conv2d(23, 180, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_8_bn1 = nn.BatchNorm2d(180, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_8_conv2 = nn.Conv2d(180, 180, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=180, bias=False)
		self.layers_8_bn2 = nn.BatchNorm2d(180, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_8_conv3 = nn.Conv2d(180, 23, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_10_conv1 = nn.Conv2d(23, 204, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_10_conv3 = nn.Conv2d(204, 44, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_10_bn3 = nn.BatchNorm2d(44, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_10_shortcut_0 = nn.Conv2d(23, 44, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_10_shortcut_1 = nn.BatchNorm2d(44, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_11_conv1 = nn.Conv2d(44, 222, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_11_conv3 = nn.Conv2d(222, 44, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_13_conv1 = nn.Conv2d(44, 246, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_13_conv3 = nn.Conv2d(246, 67, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_13_bn3 = nn.BatchNorm2d(67, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_14_conv1 = nn.Conv2d(67, 458, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_14_conv3 = nn.Conv2d(458, 67, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_15_conv1 = nn.Conv2d(67, 338, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_15_conv3 = nn.Conv2d(338, 67, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_16_conv1 = nn.Conv2d(67, 290, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_16_shortcut_0 = nn.Conv2d(67, 122, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_shortcut_1 = nn.BatchNorm2d(122, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.conv2 = nn.Conv2d(122, 992, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.bn2 = nn.BatchNorm2d(992, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.linear = nn.Linear(in_features=992, out_features=100, bias=True)
