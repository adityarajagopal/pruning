...
class MobileNetV2(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.layers_1_conv1 = nn.Conv2d(13, 50, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_1_shortcut_0 = nn.Conv2d(13, 12, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_3_conv3 = nn.Conv2d(117, 22, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_3_bn3 = nn.BatchNorm2d(22, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_4_conv1 = nn.Conv2d(22, 101, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_4_conv3 = nn.Conv2d(101, 22, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_5_conv1 = nn.Conv2d(22, 113, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_5_conv3 = nn.Conv2d(113, 22, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_9_conv1 = nn.Conv2d(10, 132, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_9_conv3 = nn.Conv2d(132, 10, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_14_conv1 = nn.Conv2d(25, 433, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_14_bn1 = nn.BatchNorm2d(433, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_14_conv2 = nn.Conv2d(433, 433, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=433, bias=False)
		self.layers_14_bn2 = nn.BatchNorm2d(433, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_14_conv3 = nn.Conv2d(433, 25, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_15_conv1 = nn.Conv2d(25, 314, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_15_conv3 = nn.Conv2d(314, 25, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_16_conv1 = nn.Conv2d(25, 280, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_16_conv3 = nn.Conv2d(280, 106, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.conv2 = nn.Conv2d(106, 704, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.bn2 = nn.BatchNorm2d(704, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.linear = nn.Linear(in_features=704, out_features=100, bias=True)
