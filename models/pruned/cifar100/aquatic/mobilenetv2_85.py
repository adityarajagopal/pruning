...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.layers_6_conv3 = nn.Conv2d(133, 18, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_6_bn3 = nn.BatchNorm2d(18, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_7_conv1 = nn.Conv2d(18, 202, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_7_conv3 = nn.Conv2d(202, 18, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_7_bn3 = nn.BatchNorm2d(18, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_8_conv1 = nn.Conv2d(18, 173, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_8_conv3 = nn.Conv2d(173, 18, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_8_bn3 = nn.BatchNorm2d(18, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_9_conv1 = nn.Conv2d(18, 135, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_9_conv3 = nn.Conv2d(135, 18, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_10_conv3 = nn.Conv2d(198, 27, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_10_bn3 = nn.BatchNorm2d(27, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_10_shortcut_0 = nn.Conv2d(18, 27, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_10_shortcut_1 = nn.BatchNorm2d(27, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_11_conv1 = nn.Conv2d(27, 214, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_11_conv3 = nn.Conv2d(214, 27, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_13_conv1 = nn.Conv2d(27, 250, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_13_conv3 = nn.Conv2d(250, 35, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_13_bn3 = nn.BatchNorm2d(35, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_14_conv1 = nn.Conv2d(35, 442, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_14_bn1 = nn.BatchNorm2d(442, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_14_conv2 = nn.Conv2d(442, 442, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=442, bias=False)
        self.layers_14_bn2 = nn.BatchNorm2d(442, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_14_conv3 = nn.Conv2d(442, 35, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_14_bn3 = nn.BatchNorm2d(35, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_15_conv1 = nn.Conv2d(35, 330, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_15_conv3 = nn.Conv2d(330, 35, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_15_bn3 = nn.BatchNorm2d(35, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_16_conv1 = nn.Conv2d(35, 284, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_16_conv3 = nn.Conv2d(284, 114, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_16_bn3 = nn.BatchNorm2d(114, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_16_shortcut_0 = nn.Conv2d(35, 114, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_16_shortcut_1 = nn.BatchNorm2d(114, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.conv2 = nn.Conv2d(114, 858, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.bn2 = nn.BatchNorm2d(858, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.avgpool = nn.AvgPool2d(kernel_size=4, stride=4, padding=0)
        self.linear = nn.Linear(in_features=858, out_features=100, bias=True)
