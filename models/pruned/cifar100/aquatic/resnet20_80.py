...
class ResNet20(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.layer2_2_conv1 = nn.Conv2d(9, 29, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
		self.layer2_2_bn1 = nn.BatchNorm2d(29, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layer2_2_conv2 = nn.Conv2d(29, 9, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
		self.layer2_2_bn2 = nn.BatchNorm2d(9, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layer3_0_conv1 = nn.Conv2d(9, 58, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), bias=False)
		...
		self.layer3_0_downsample_0 = nn.Conv2d(9, 13, kernel_size=(1, 1), stride=(2, 2), bias=False)
		...
		self.layer3_2_conv1 = nn.Conv2d(13, 43, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
		self.layer3_2_bn1 = nn.BatchNorm2d(43, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layer3_2_conv2 = nn.Conv2d(43, 13, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
