...
class MobileNetV2(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.layers_8_conv1 = nn.Conv2d(60, 210, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_8_bn1 = nn.BatchNorm2d(210, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_8_conv2 = nn.Conv2d(210, 210, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=210, bias=False)
		self.layers_8_bn2 = nn.BatchNorm2d(210, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_8_conv3 = nn.Conv2d(210, 60, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_9_conv1 = nn.Conv2d(60, 173, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_9_conv3 = nn.Conv2d(173, 60, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_10_conv1 = nn.Conv2d(60, 225, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_10_bn1 = nn.BatchNorm2d(225, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_10_conv2 = nn.Conv2d(225, 225, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=225, bias=False)
		self.layers_10_bn2 = nn.BatchNorm2d(225, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_10_conv3 = nn.Conv2d(225, 77, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_11_conv1 = nn.Conv2d(77, 244, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_11_conv3 = nn.Conv2d(244, 77, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_12_conv1 = nn.Conv2d(77, 257, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_12_conv3 = nn.Conv2d(257, 77, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_13_conv1 = nn.Conv2d(77, 270, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_14_conv1 = nn.Conv2d(136, 495, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_14_bn1 = nn.BatchNorm2d(495, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_14_conv2 = nn.Conv2d(495, 495, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=495, bias=False)
		self.layers_14_bn2 = nn.BatchNorm2d(495, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_14_conv3 = nn.Conv2d(495, 136, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_16_conv1 = nn.Conv2d(136, 315, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_16_conv3 = nn.Conv2d(315, 281, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.conv2 = nn.Conv2d(281, 1212, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.bn2 = nn.BatchNorm2d(1212, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.linear = nn.Linear(in_features=1212, out_features=100, bias=True)
