...
class SqueezeNet(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.fire5_conv3 = nn.Conv2d(31, 55, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire5_bn3 = nn.BatchNorm2d(55, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire6_conv1 = nn.Conv2d(182, 48, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire7_conv2 = nn.Conv2d(48, 159, kernel_size=(1, 1), stride=(1, 1))
		self.fire7_bn2 = nn.BatchNorm2d(159, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
