...
class SqueezeNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.fire4_conv2 = nn.Conv2d(32, 78, kernel_size=(1, 1), stride=(1, 1))
        self.fire4_bn2 = nn.BatchNorm2d(78, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.fire6_conv2 = nn.Conv2d(48, 116, kernel_size=(1, 1), stride=(1, 1))
        self.fire6_bn2 = nn.BatchNorm2d(116, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.fire7_conv1 = nn.Conv2d(144, 48, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire7_conv3 = nn.Conv2d(48, 109, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire7_bn3 = nn.BatchNorm2d(109, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire8_conv1 = nn.Conv2d(276, 64, kernel_size=(1, 1), stride=(1, 1))
