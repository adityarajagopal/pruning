...
class ResNet20(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.layer2_1_conv1 = nn.Conv2d(10, 27, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
		self.layer2_1_bn1 = nn.BatchNorm2d(27, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layer2_1_conv2 = nn.Conv2d(27, 10, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
		...
		self.layer3_1_conv1 = nn.Conv2d(16, 54, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
		self.layer3_1_bn1 = nn.BatchNorm2d(54, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layer3_1_conv2 = nn.Conv2d(54, 16, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
