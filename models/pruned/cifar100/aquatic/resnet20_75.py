...
class ResNet20(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.layer2_1_conv1 = nn.Conv2d(9, 31, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
		self.layer2_1_bn1 = nn.BatchNorm2d(31, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layer2_1_conv2 = nn.Conv2d(31, 9, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
		...
		self.layer3_0_conv1 = nn.Conv2d(9, 63, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), bias=False)
		...
		self.layer3_0_downsample_0 = nn.Conv2d(9, 16, kernel_size=(1, 1), stride=(2, 2), bias=False)
		self.layer3_0_downsample_1 = nn.BatchNorm2d(16, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layer3_1_conv1 = nn.Conv2d(16, 60, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
		self.layer3_1_bn1 = nn.BatchNorm2d(60, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layer3_1_conv2 = nn.Conv2d(60, 16, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)
