...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.layers_2_conv1 = nn.Conv2d(14, 67, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_2_conv3 = nn.Conv2d(67, 14, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_6_conv3 = nn.Conv2d(133, 22, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_6_bn3 = nn.BatchNorm2d(22, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_7_conv1 = nn.Conv2d(22, 206, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_7_conv3 = nn.Conv2d(206, 22, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_7_bn3 = nn.BatchNorm2d(22, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_8_conv1 = nn.Conv2d(22, 182, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_8_conv3 = nn.Conv2d(182, 22, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_8_bn3 = nn.BatchNorm2d(22, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_9_conv1 = nn.Conv2d(22, 141, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_9_conv3 = nn.Conv2d(141, 22, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_9_bn3 = nn.BatchNorm2d(22, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_10_conv1 = nn.Conv2d(22, 200, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_10_conv3 = nn.Conv2d(200, 43, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_11_conv1 = nn.Conv2d(43, 222, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_11_conv3 = nn.Conv2d(222, 43, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_13_conv1 = nn.Conv2d(43, 251, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_13_conv3 = nn.Conv2d(251, 53, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_13_bn3 = nn.BatchNorm2d(53, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_14_conv1 = nn.Conv2d(53, 450, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_14_conv3 = nn.Conv2d(450, 53, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_14_bn3 = nn.BatchNorm2d(53, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_15_conv1 = nn.Conv2d(53, 339, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_15_conv3 = nn.Conv2d(339, 53, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_15_bn3 = nn.BatchNorm2d(53, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_16_conv1 = nn.Conv2d(53, 285, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_16_shortcut_0 = nn.Conv2d(53, 123, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_16_shortcut_1 = nn.BatchNorm2d(123, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.conv2 = nn.Conv2d(123, 978, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.bn2 = nn.BatchNorm2d(978, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.avgpool = nn.AvgPool2d(kernel_size=4, stride=4, padding=0)
        self.linear = nn.Linear(in_features=978, out_features=100, bias=True)
