...
class AlexNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.conv2 = nn.Conv2d(64, 165, kernel_size=(5, 5), stride=(1, 1), padding=(2, 2))
        self.maxpool2d_2 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
        self.conv3 = nn.Conv2d(165, 42, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.conv4 = nn.Conv2d(42, 2, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.conv5 = nn.Conv2d(2, 191, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.maxpool2d_3 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
        self.classifier = nn.Linear(in_features=191, out_features=100, bias=True)
