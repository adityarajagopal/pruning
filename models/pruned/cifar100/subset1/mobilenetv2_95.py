...
class MobileNetV2(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.layers_0_conv1 = nn.Conv2d(13, 2, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_0_shortcut_0 = nn.Conv2d(13, 8, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_16_conv3 = nn.Conv2d(2, 115, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_bn3 = nn.BatchNorm2d(115, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_16_shortcut_0 = nn.Conv2d(9, 115, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_shortcut_1 = nn.BatchNorm2d(115, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.conv2 = nn.Conv2d(115, 582, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.bn2 = nn.BatchNorm2d(582, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.linear = nn.Linear(in_features=582, out_features=100, bias=True)
