...
class SqueezeNet(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.fire2_conv3 = nn.Conv2d(15, 50, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire2_bn3 = nn.BatchNorm2d(50, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire3_conv1 = nn.Conv2d(114, 16, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire4_conv2 = nn.Conv2d(32, 97, kernel_size=(1, 1), stride=(1, 1))
		self.fire4_bn2 = nn.BatchNorm2d(97, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		...
		self.fire5_conv1 = nn.Conv2d(223, 32, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire5_conv3 = nn.Conv2d(32, 116, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire5_bn3 = nn.BatchNorm2d(116, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire6_conv1 = nn.Conv2d(243, 48, kernel_size=(1, 1), stride=(1, 1))
		self.fire6_bn1 = nn.BatchNorm2d(48, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire6_conv2 = nn.Conv2d(48, 147, kernel_size=(1, 1), stride=(1, 1))
		self.fire6_bn2 = nn.BatchNorm2d(147, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire6_conv3 = nn.Conv2d(48, 66, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire6_bn3 = nn.BatchNorm2d(66, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire7_conv1 = nn.Conv2d(213, 48, kernel_size=(1, 1), stride=(1, 1))
		self.fire7_bn1 = nn.BatchNorm2d(48, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire7_conv2 = nn.Conv2d(48, 183, kernel_size=(1, 1), stride=(1, 1))
		self.fire7_bn2 = nn.BatchNorm2d(183, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire7_conv3 = nn.Conv2d(48, 173, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire7_bn3 = nn.BatchNorm2d(173, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire8_conv1 = nn.Conv2d(356, 64, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire8_conv3 = nn.Conv2d(64, 237, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire8_bn3 = nn.BatchNorm2d(237, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.maxpool3 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
		self.fire9_conv1 = nn.Conv2d(481, 64, kernel_size=(1, 1), stride=(1, 1))
