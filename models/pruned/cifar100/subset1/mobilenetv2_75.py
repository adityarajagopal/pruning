...
class MobileNetV2(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.layers_6_conv3 = nn.Conv2d(133, 19, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_6_bn3 = nn.BatchNorm2d(19, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_7_conv1 = nn.Conv2d(19, 208, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_7_conv3 = nn.Conv2d(208, 19, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_8_conv1 = nn.Conv2d(19, 187, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_8_conv3 = nn.Conv2d(187, 19, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_9_conv1 = nn.Conv2d(19, 141, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_9_conv3 = nn.Conv2d(141, 19, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_10_conv3 = nn.Conv2d(201, 48, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_10_bn3 = nn.BatchNorm2d(48, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_10_shortcut_0 = nn.Conv2d(19, 48, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_10_shortcut_1 = nn.BatchNorm2d(48, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_11_conv1 = nn.Conv2d(48, 229, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_11_conv3 = nn.Conv2d(229, 48, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_12_conv1 = nn.Conv2d(48, 222, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_12_conv3 = nn.Conv2d(222, 48, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_13_conv1 = nn.Conv2d(48, 237, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_13_conv3 = nn.Conv2d(237, 66, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_13_bn3 = nn.BatchNorm2d(66, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_14_conv1 = nn.Conv2d(66, 461, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_14_conv3 = nn.Conv2d(461, 66, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_15_conv1 = nn.Conv2d(66, 346, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_15_conv3 = nn.Conv2d(346, 66, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_16_conv3 = nn.Conv2d(290, 122, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_bn3 = nn.BatchNorm2d(122, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_16_shortcut_0 = nn.Conv2d(66, 122, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_shortcut_1 = nn.BatchNorm2d(122, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.conv2 = nn.Conv2d(122, 995, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.bn2 = nn.BatchNorm2d(995, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.linear = nn.Linear(in_features=995, out_features=100, bias=True)
