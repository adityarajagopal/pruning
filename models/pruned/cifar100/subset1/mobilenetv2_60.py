...
class MobileNetV2(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.layers_2_conv1 = nn.Conv2d(21, 76, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_2_conv3 = nn.Conv2d(76, 21, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_6_conv3 = nn.Conv2d(137, 43, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_6_bn3 = nn.BatchNorm2d(43, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_7_conv1 = nn.Conv2d(43, 217, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_7_conv3 = nn.Conv2d(217, 43, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_8_conv1 = nn.Conv2d(43, 199, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_8_conv3 = nn.Conv2d(199, 43, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_9_conv1 = nn.Conv2d(43, 155, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_9_conv3 = nn.Conv2d(155, 43, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_10_conv1 = nn.Conv2d(43, 213, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_10_conv3 = nn.Conv2d(213, 58, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_11_conv1 = nn.Conv2d(58, 239, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_11_conv3 = nn.Conv2d(239, 58, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_13_conv3 = nn.Conv2d(251, 126, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_13_bn3 = nn.BatchNorm2d(126, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_14_conv1 = nn.Conv2d(126, 480, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_14_conv3 = nn.Conv2d(480, 126, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_15_conv1 = nn.Conv2d(126, 370, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_15_conv3 = nn.Conv2d(370, 126, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_16_conv1 = nn.Conv2d(126, 299, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_16_conv3 = nn.Conv2d(299, 209, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_bn3 = nn.BatchNorm2d(209, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_16_shortcut_0 = nn.Conv2d(126, 209, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_shortcut_1 = nn.BatchNorm2d(209, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.conv2 = nn.Conv2d(209, 1136, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.bn2 = nn.BatchNorm2d(1136, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.linear = nn.Linear(in_features=1136, out_features=100, bias=True)
