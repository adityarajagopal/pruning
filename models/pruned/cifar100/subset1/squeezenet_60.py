...
class SqueezeNet(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.fire5_conv1 = nn.Conv2d(191, 32, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire6_conv3 = nn.Conv2d(48, 27, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire6_bn3 = nn.BatchNorm2d(27, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire7_conv1 = nn.Conv2d(142, 48, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire8_conv3 = nn.Conv2d(64, 109, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire8_bn3 = nn.BatchNorm2d(109, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.maxpool3 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
		self.fire9_conv1 = nn.Conv2d(343, 64, kernel_size=(1, 1), stride=(1, 1))
