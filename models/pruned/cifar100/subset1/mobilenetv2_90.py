...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.layers_1_conv1 = nn.Conv2d(15, 46, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_1_conv3 = nn.Conv2d(46, 11, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_2_conv1 = nn.Conv2d(11, 68, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_2_conv3 = nn.Conv2d(68, 11, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_3_conv3 = nn.Conv2d(117, 24, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_3_bn3 = nn.BatchNorm2d(24, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_4_conv1 = nn.Conv2d(24, 102, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_4_conv3 = nn.Conv2d(102, 24, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_4_bn3 = nn.BatchNorm2d(24, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_5_conv1 = nn.Conv2d(24, 114, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_5_conv3 = nn.Conv2d(114, 24, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_5_bn3 = nn.BatchNorm2d(24, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_6_conv1 = nn.Conv2d(24, 131, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_6_conv3 = nn.Conv2d(131, 8, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_6_bn3 = nn.BatchNorm2d(8, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_7_conv1 = nn.Conv2d(8, 198, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_7_conv3 = nn.Conv2d(198, 8, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_7_bn3 = nn.BatchNorm2d(8, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_8_conv1 = nn.Conv2d(8, 167, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_8_conv3 = nn.Conv2d(167, 8, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_8_bn3 = nn.BatchNorm2d(8, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_9_conv1 = nn.Conv2d(8, 125, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_9_conv3 = nn.Conv2d(125, 8, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_9_bn3 = nn.BatchNorm2d(8, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_10_conv1 = nn.Conv2d(8, 195, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_10_shortcut_0 = nn.Conv2d(8, 17, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_10_shortcut_1 = nn.BatchNorm2d(17, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_11_conv1 = nn.Conv2d(17, 216, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_11_conv3 = nn.Conv2d(216, 17, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_11_bn3 = nn.BatchNorm2d(17, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_12_conv1 = nn.Conv2d(17, 212, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_12_conv3 = nn.Conv2d(212, 17, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_12_bn3 = nn.BatchNorm2d(17, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_13_conv1 = nn.Conv2d(17, 234, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_13_conv3 = nn.Conv2d(234, 20, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_15_conv1 = nn.Conv2d(20, 321, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_15_conv3 = nn.Conv2d(321, 20, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_15_bn3 = nn.BatchNorm2d(20, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.layers_16_conv1 = nn.Conv2d(20, 276, kernel_size=(1, 1), stride=(1, 1), bias=False)
        ...
        self.layers_16_shortcut_0 = nn.Conv2d(20, 110, kernel_size=(1, 1), stride=(1, 1), bias=False)
        self.layers_16_shortcut_1 = nn.BatchNorm2d(110, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.conv2 = nn.Conv2d(110, 677, kernel_size=(1, 1), stride=(1, 1), bias=False)
