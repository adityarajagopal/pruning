...
class MobileNetV2(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.layers_0_conv1 = nn.Conv2d(26, 20, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_2_conv1 = nn.Conv2d(24, 98, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_2_bn1 = nn.BatchNorm2d(98, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_2_conv2 = nn.Conv2d(98, 98, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=98, bias=False)
		self.layers_2_bn2 = nn.BatchNorm2d(98, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_2_conv3 = nn.Conv2d(98, 24, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_4_conv1 = nn.Conv2d(32, 141, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_4_bn1 = nn.BatchNorm2d(141, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_4_conv2 = nn.Conv2d(141, 141, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=141, bias=False)
		self.layers_4_bn2 = nn.BatchNorm2d(141, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_4_conv3 = nn.Conv2d(141, 32, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_5_conv1 = nn.Conv2d(32, 134, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_5_bn1 = nn.BatchNorm2d(134, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_5_conv2 = nn.Conv2d(134, 134, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=134, bias=False)
		self.layers_5_bn2 = nn.BatchNorm2d(134, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_5_conv3 = nn.Conv2d(134, 32, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_7_conv1 = nn.Conv2d(64, 282, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_7_bn1 = nn.BatchNorm2d(282, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_7_conv2 = nn.Conv2d(282, 282, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=282, bias=False)
		self.layers_7_bn2 = nn.BatchNorm2d(282, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_7_conv3 = nn.Conv2d(282, 64, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_8_conv1 = nn.Conv2d(64, 293, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_8_bn1 = nn.BatchNorm2d(293, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_8_conv2 = nn.Conv2d(293, 293, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=293, bias=False)
		self.layers_8_bn2 = nn.BatchNorm2d(293, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_8_conv3 = nn.Conv2d(293, 64, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_9_conv1 = nn.Conv2d(64, 246, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_9_bn1 = nn.BatchNorm2d(246, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_9_conv2 = nn.Conv2d(246, 246, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=246, bias=False)
		self.layers_9_bn2 = nn.BatchNorm2d(246, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_9_conv3 = nn.Conv2d(246, 64, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_10_conv1 = nn.Conv2d(64, 304, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_10_bn1 = nn.BatchNorm2d(304, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_10_conv2 = nn.Conv2d(304, 304, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=304, bias=False)
		self.layers_10_bn2 = nn.BatchNorm2d(304, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_10_conv3 = nn.Conv2d(304, 96, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_11_conv1 = nn.Conv2d(96, 380, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_11_bn1 = nn.BatchNorm2d(380, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_11_conv2 = nn.Conv2d(380, 380, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=380, bias=False)
		self.layers_11_bn2 = nn.BatchNorm2d(380, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_11_conv3 = nn.Conv2d(380, 96, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_12_conv1 = nn.Conv2d(96, 413, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_12_bn1 = nn.BatchNorm2d(413, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_12_conv2 = nn.Conv2d(413, 413, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=413, bias=False)
		self.layers_12_bn2 = nn.BatchNorm2d(413, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_12_conv3 = nn.Conv2d(413, 96, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_13_conv1 = nn.Conv2d(96, 431, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_13_bn1 = nn.BatchNorm2d(431, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_13_conv2 = nn.Conv2d(431, 431, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), groups=431, bias=False)
		self.layers_13_bn2 = nn.BatchNorm2d(431, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_13_conv3 = nn.Conv2d(431, 160, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_13_bn3 = nn.BatchNorm2d(160, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_14_conv1 = nn.Conv2d(160, 684, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_14_bn1 = nn.BatchNorm2d(684, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_14_conv2 = nn.Conv2d(684, 684, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=684, bias=False)
		self.layers_14_bn2 = nn.BatchNorm2d(684, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_14_conv3 = nn.Conv2d(684, 160, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_15_conv1 = nn.Conv2d(160, 613, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_15_bn1 = nn.BatchNorm2d(613, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_15_conv2 = nn.Conv2d(613, 613, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=613, bias=False)
		self.layers_15_bn2 = nn.BatchNorm2d(613, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_15_conv3 = nn.Conv2d(613, 160, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_16_conv1 = nn.Conv2d(160, 587, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_bn1 = nn.BatchNorm2d(587, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_16_conv2 = nn.Conv2d(587, 587, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=587, bias=False)
		self.layers_16_bn2 = nn.BatchNorm2d(587, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_16_conv3 = nn.Conv2d(587, 320, kernel_size=(1, 1), stride=(1, 1), bias=False)
