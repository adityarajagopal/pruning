...
class SqueezeNet(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.fire2_conv3 = nn.Conv2d(15, 27, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire2_bn3 = nn.BatchNorm2d(27, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire3_conv1 = nn.Conv2d(91, 16, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire4_conv2 = nn.Conv2d(32, 65, kernel_size=(1, 1), stride=(1, 1))
		self.fire4_bn2 = nn.BatchNorm2d(65, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire4_conv3 = nn.Conv2d(32, 56, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire4_bn3 = nn.BatchNorm2d(56, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.maxpool2 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
		self.fire5_conv1 = nn.Conv2d(121, 31, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire5_conv3 = nn.Conv2d(31, 34, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire5_bn3 = nn.BatchNorm2d(34, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire6_conv1 = nn.Conv2d(159, 48, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire7_conv1 = nn.Conv2d(93, 48, kernel_size=(1, 1), stride=(1, 1))
		self.fire7_bn1 = nn.BatchNorm2d(48, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire7_conv2 = nn.Conv2d(48, 150, kernel_size=(1, 1), stride=(1, 1))
		self.fire7_bn2 = nn.BatchNorm2d(150, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire7_conv3 = nn.Conv2d(48, 41, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire7_bn3 = nn.BatchNorm2d(41, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire8_conv1 = nn.Conv2d(191, 64, kernel_size=(1, 1), stride=(1, 1))
		self.fire8_bn1 = nn.BatchNorm2d(64, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire8_conv2 = nn.Conv2d(64, 209, kernel_size=(1, 1), stride=(1, 1))
		self.fire8_bn2 = nn.BatchNorm2d(209, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire8_conv3 = nn.Conv2d(64, 7, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire8_bn3 = nn.BatchNorm2d(7, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.maxpool3 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
		self.fire9_conv1 = nn.Conv2d(216, 64, kernel_size=(1, 1), stride=(1, 1))
