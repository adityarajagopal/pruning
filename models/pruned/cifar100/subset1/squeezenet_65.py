...
class SqueezeNet(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.fire6_conv2 = nn.Conv2d(48, 112, kernel_size=(1, 1), stride=(1, 1))
		self.fire6_bn2 = nn.BatchNorm2d(112, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		...
		self.fire7_conv1 = nn.Conv2d(135, 48, kernel_size=(1, 1), stride=(1, 1))
		self.fire7_bn1 = nn.BatchNorm2d(48, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire7_conv2 = nn.Conv2d(48, 164, kernel_size=(1, 1), stride=(1, 1))
		self.fire7_bn2 = nn.BatchNorm2d(164, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		...
		self.fire8_conv1 = nn.Conv2d(261, 64, kernel_size=(1, 1), stride=(1, 1))
		self.fire8_bn1 = nn.BatchNorm2d(64, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire8_conv2 = nn.Conv2d(64, 229, kernel_size=(1, 1), stride=(1, 1))
		self.fire8_bn2 = nn.BatchNorm2d(229, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
