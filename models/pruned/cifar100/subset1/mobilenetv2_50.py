...
class MobileNetV2(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.layers_8_conv1 = nn.Conv2d(60, 208, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_8_conv3 = nn.Conv2d(208, 60, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_9_conv1 = nn.Conv2d(60, 170, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_9_conv3 = nn.Conv2d(170, 60, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_10_conv3 = nn.Conv2d(223, 79, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_10_bn3 = nn.BatchNorm2d(79, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_10_shortcut_0 = nn.Conv2d(60, 79, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_10_shortcut_1 = nn.BatchNorm2d(79, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_11_conv1 = nn.Conv2d(79, 250, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_11_conv3 = nn.Conv2d(250, 79, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_12_conv1 = nn.Conv2d(79, 257, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_12_conv3 = nn.Conv2d(257, 79, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_13_conv1 = nn.Conv2d(79, 263, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_14_conv1 = nn.Conv2d(136, 501, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_14_bn1 = nn.BatchNorm2d(501, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_14_conv2 = nn.Conv2d(501, 501, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=501, bias=False)
		self.layers_14_bn2 = nn.BatchNorm2d(501, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_14_conv3 = nn.Conv2d(501, 136, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_16_conv1 = nn.Conv2d(136, 316, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_bn1 = nn.BatchNorm2d(316, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_16_conv2 = nn.Conv2d(316, 316, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=316, bias=False)
		self.layers_16_bn2 = nn.BatchNorm2d(316, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_16_conv3 = nn.Conv2d(316, 279, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_bn3 = nn.BatchNorm2d(279, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_16_shortcut_0 = nn.Conv2d(136, 279, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_shortcut_1 = nn.BatchNorm2d(279, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.conv2 = nn.Conv2d(279, 1206, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.bn2 = nn.BatchNorm2d(1206, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.linear = nn.Linear(in_features=1206, out_features=100, bias=True)
