...
class SqueezeNet(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.fire5_conv1 = nn.Conv2d(224, 32, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire5_conv3 = nn.Conv2d(32, 119, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire5_bn3 = nn.BatchNorm2d(119, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire6_conv1 = nn.Conv2d(246, 48, kernel_size=(1, 1), stride=(1, 1))
		self.fire6_bn1 = nn.BatchNorm2d(48, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire6_conv2 = nn.Conv2d(48, 151, kernel_size=(1, 1), stride=(1, 1))
		self.fire6_bn2 = nn.BatchNorm2d(151, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire6_conv3 = nn.Conv2d(48, 75, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire6_bn3 = nn.BatchNorm2d(75, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		...
		self.fire7_conv3 = nn.Conv2d(48, 176, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire7_bn3 = nn.BatchNorm2d(176, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.fire8_conv1 = nn.Conv2d(359, 64, kernel_size=(1, 1), stride=(1, 1))
		...
		self.fire8_conv3 = nn.Conv2d(64, 247, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
		self.fire8_bn3 = nn.BatchNorm2d(247, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.maxpool3 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
		self.fire9_conv1 = nn.Conv2d(493, 64, kernel_size=(1, 1), stride=(1, 1))
