...
class MobileNetV2(nn.Module):
	def __init__(self, num_classes=10):
		...
		self.layers_0_conv1 = nn.Conv2d(22, 32, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_1_conv3 = nn.Conv2d(96, 22, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_2_conv1 = nn.Conv2d(22, 144, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_2_shortcut_0 = nn.Conv2d(22, 24, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_8_conv3 = nn.Conv2d(384, 62, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_8_bn3 = nn.BatchNorm2d(62, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_8_shortcut_0 = nn.Conv2d(61, 62, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_8_shortcut_1 = nn.BatchNorm2d(62, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_9_conv1 = nn.Conv2d(62, 384, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_9_conv3 = nn.Conv2d(384, 51, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_9_bn3 = nn.BatchNorm2d(51, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_9_shortcut_0 = nn.Conv2d(62, 51, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_9_shortcut_1 = nn.BatchNorm2d(51, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_10_conv1 = nn.Conv2d(51, 384, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_10_conv3 = nn.Conv2d(384, 89, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_10_bn3 = nn.BatchNorm2d(89, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_10_shortcut_0 = nn.Conv2d(51, 89, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_10_shortcut_1 = nn.BatchNorm2d(89, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_11_conv1 = nn.Conv2d(89, 576, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_11_conv3 = nn.Conv2d(576, 67, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_11_bn3 = nn.BatchNorm2d(67, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_11_shortcut_0 = nn.Conv2d(89, 67, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_11_shortcut_1 = nn.BatchNorm2d(67, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_12_conv1 = nn.Conv2d(67, 576, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_12_conv3 = nn.Conv2d(576, 78, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_12_bn3 = nn.BatchNorm2d(78, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_12_shortcut_0 = nn.Conv2d(67, 78, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_12_shortcut_1 = nn.BatchNorm2d(78, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_13_conv1 = nn.Conv2d(78, 576, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_14_conv3 = nn.Conv2d(960, 137, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_14_bn3 = nn.BatchNorm2d(137, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_14_shortcut_0 = nn.Conv2d(160, 137, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_14_shortcut_1 = nn.BatchNorm2d(137, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_15_conv1 = nn.Conv2d(137, 960, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_15_conv3 = nn.Conv2d(960, 124, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_15_bn3 = nn.BatchNorm2d(124, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_15_shortcut_0 = nn.Conv2d(137, 124, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_15_shortcut_1 = nn.BatchNorm2d(124, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_16_conv1 = nn.Conv2d(124, 960, kernel_size=(1, 1), stride=(1, 1), bias=False)
		...
		self.layers_16_conv3 = nn.Conv2d(960, 218, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_bn3 = nn.BatchNorm2d(218, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.layers_16_shortcut_0 = nn.Conv2d(124, 218, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.layers_16_shortcut_1 = nn.BatchNorm2d(218, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.conv2 = nn.Conv2d(218, 1125, kernel_size=(1, 1), stride=(1, 1), bias=False)
		self.bn2 = nn.BatchNorm2d(1125, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
		self.linear = nn.Linear(in_features=1125, out_features=100, bias=True)
