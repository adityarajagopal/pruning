...
class SqueezeNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.fire2_conv3 = nn.Conv2d(15, 45, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire2_bn3 = nn.BatchNorm2d(45, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire3_conv1 = nn.Conv2d(109, 16, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire5_conv3 = nn.Conv2d(32, 104, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire5_bn3 = nn.BatchNorm2d(104, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire6_conv1 = nn.Conv2d(231, 48, kernel_size=(1, 1), stride=(1, 1))
        self.fire6_bn1 = nn.BatchNorm2d(48, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire6_conv2 = nn.Conv2d(48, 143, kernel_size=(1, 1), stride=(1, 1))
        self.fire6_bn2 = nn.BatchNorm2d(143, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.fire7_conv1 = nn.Conv2d(185, 48, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire7_conv3 = nn.Conv2d(48, 148, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire7_bn3 = nn.BatchNorm2d(148, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.fire8_conv3 = nn.Conv2d(64, 163, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire8_bn3 = nn.BatchNorm2d(163, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.maxpool3 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
        self.fire9_conv1 = nn.Conv2d(404, 64, kernel_size=(1, 1), stride=(1, 1))
