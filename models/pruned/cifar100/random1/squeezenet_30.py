...
class SqueezeNet(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.fire2_conv3 = nn.Conv2d(15, 56, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fire2_bn3 = nn.BatchNorm2d(56, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.fire3_conv1 = nn.Conv2d(120, 16, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire4_conv2 = nn.Conv2d(32, 115, kernel_size=(1, 1), stride=(1, 1))
        self.fire4_bn2 = nn.BatchNorm2d(115, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        ...
        self.fire5_conv1 = nn.Conv2d(243, 32, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire7_conv1 = nn.Conv2d(335, 48, kernel_size=(1, 1), stride=(1, 1))
        ...
        self.fire8_conv1 = nn.Conv2d(379, 64, kernel_size=(1, 1), stride=(1, 1))
