        ...
        #{{{
            ...
            #{{{
                ...
                if os.environ['STORE_DICT']:
                    torch.save(prunedModel.state_dict(), '/home/ar4414/pytorch_training/src/ar4414/pruning/master.pth.tar')
                    torch.save(optimiser.param_groups, '/home/ar4414/pytorch_training/src/ar4414/pruning/master_opt.pth.tar')
                    torch.save(list(self.test_loader), '/home/ar4414/pytorch_training/src/ar4414/pruning/master_test_loader.pth.tar')
